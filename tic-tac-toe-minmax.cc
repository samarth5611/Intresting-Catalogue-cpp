...
{
        cout << endl
             << game[0][0] << " | " << game[0][1] << " | " << game[0][2] << endl;
        cout << "__  _   __ " << endl;
        cout << endl
...
bool checkWinComputer()
{
        for (int i = 0; i < 3; i++)
        {
                if (game[i][0] == game[i][1] && game[i][1] == game[i][2] && game[i][0] == 'X')
                        return true;
        }

        for (int i = 0; i < 3; i++)
        {
                if (game[0][i] == game[1][i] && game[1][i] == game[2][i] && game[0][i] == 'X')
                        return true;
        }
